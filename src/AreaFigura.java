...
public class AreaFigura {
    public static void main(String[] args) {
        ...
        float opcion = Integer.parseInt(scanner.nextLine());

        if (opcion == 1) {
            System.out.println("Ingrese la base del rectángulo: ");
            double base = scanner.nextFloat(); // Error: Método incorrecto para leer decimales
            ...
            double radio = scanner.nextFloat(); // Error: Método incorrecto para leer decimales

            float area = 3.1416 * radio ^ 2;
